...
public class FrameFront<E> {
	private static final ListCellRenderer<? super String> UIResource = null;
...
//		Field IMC
		...
		txtImc.setBounds(130, 275, 80, 30);
		txtImc.setFont(fontText);
//		Field NCD
		JTextField txtNcd = new JTextField();
		txtNcd.setBounds(130, 315, 80, 30);
		txtNcd.setFont(fontText);
...
//		Combobox Atividade Fisica
		String[] opcoesAtividadeFisica = {"<Selecione>", "Leve", "Moderada", "Intensa"};
		JComboBox<String> listAtividadeFisica = new JComboBox<String>(opcoesAtividadeFisica);
		listAtividadeFisica.setSelectedIndex(0);
		listAtividadeFisica.addActionListener(listAtividadeFisica);
		listAtividadeFisica.setLayout(null);
		listAtividadeFisica.setBounds(190, 215, 130, 20);
...
//		telaFront.getContentPane().add(labelStatusNcd);
		...
		telaFront.getContentPane().add(txtNcd);
		telaFront.getContentPane().add(txtImc);
		...
		listAtividadeFisica.addActionListener(new ActionListener() {
			
			public void actionPerformed(ActionEvent e) {
				Pessoa p = new Pessoa();
				if(e.getSource() == listAtividadeFisica) {
					JComboBox cb = (JComboBox)e.getSource();
					String msg = (String)cb.getSelectedItem();
					switch(msg) {
						case "Leve": p.setTipoAtividade("Leve");
							break;
						case "Moderado": p.setTipoAtividade("Moderado");
							break;
						case "Intensa": p.setTipoAtividade("Intensa");
							break;
					}
				}
